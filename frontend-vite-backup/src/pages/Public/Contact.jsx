  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-12 space-y-16 text-slate-800 dark:text-slate-100 text-left">
          ...
          <div className="bg-white dark:bg-slate-800/60 rounded-2xl shadow-xl border border-slate-200/50 dark:border-slate-700/50 p-6 lg:p-8">
            {submitted ? (
              <div className="text-center py-8 space-y-4 max-w-sm mx-auto">
                <div className="w-14 h-14 rounded-full bg-emerald-500/10 text-emerald-600 flex items-center justify-center mx-auto shadow-md">
                  <CheckCircle size={32} />
                </div>
                <h3 className="font-bold text-xl text-slate-900 dark:text-white">Ticket Submitted</h3>
                <p className="text-xs text-slate-500 dark:text-slate-405 font-light leading-relaxed">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <p className="text-xs text-slate-400 font-light">Submit your query. Responses from admin appear in notifications logs once addressed.</p>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2 rounded-xl border border-slate-200 dark:border-slate-800 bg-white/70 dark:bg-slate-900/50 text-xs focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-[10px] font-bold uppercase tracking-wider mb-1.5 text-slate-500">Email Address</label>
                    <input
                      type="email"
                      required
                  ...
                  <div>
                    <label className="block text-[10px] font-bold uppercase tracking-wider mb-1.5 text-slate-500">Inquiry Subject</label>
                    <input
                      type="text"
                      required
                ...
                <div>
                  <label className="block text-[10px] font-bold uppercase tracking-wider mb-1.5 text-slate-500">Your Message Description</label>
                  <textarea
                    rows={4}
                    required
      ...
      <div className="space-y-4">
        ...
        <div className="w-full h-80 rounded-3xl border border-slate-200/50 dark:border-slate-800/80 overflow-hidden shadow-lg relative bg-slate-100 dark:bg-slate-900 flex items-center justify-center">
          ...
          <div className="relative z-10 text-center space-y-3">
            ...
            <h4 className="font-extrabold text-sm text-slate-900 dark:text-white">Sri Vani Vidyanikethan, Kottala Campus</h4>
