  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center p-6 text-slate-800 dark:text-slate-100 relative overflow-hidden">
      ...
      {stage === 'select-role' ? (
        ...
        <div className="w-full max-w-6xl space-y-10 text-center relative z-10">
          ...
          <div className="pt-6">
            <button 
              ...
              className="text-xs text-slate-450 hover:text-slate-700 dark:hover:text-slate-200 underline underline-offset-4"
            >
              Are you a faculty member or Super Admin? Access login panel here
            </button>
          </div>
        </div>
      ) : (
