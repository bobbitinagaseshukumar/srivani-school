...
export default function Admissions() {
  ...
  const handleSubmit = (e) => {
    ...
    // Add dynamic notification & log
    addNotification('New Admission Inquiry', `Inquiry received for student ${formData.studentName} entering ${formData.grade}`, 'Admission');
    addAuditLog('Guest User', 'Public User', `Submitted online admission form for student ${formData.studentName}`);
    setSubmitted(true);
  };
      ...
      <div className="grid lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-5 space-y-4">
          <div className="glassmorphism p-6 rounded-2xl border border-white/40 shadow-lg space-y-4">
            ...
            <ul className="space-y-2 text-xs font-light text-slate-650 dark:text-slate-350">
        ...
        {submitted ? (
          <div className="text-center py-10 space-y-4 max-w-md mx-auto">
            ...
            <button
              onClick={() => {
                setSubmitted(false);
                setFormData({ studentName: '', dob: '', gender: '', grade: 'Class 10', parentName: '', parentEmail: '', parentPhone: '', address: '', prevSchool: '' });
              }}
