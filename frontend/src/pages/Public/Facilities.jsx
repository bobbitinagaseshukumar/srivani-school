    ...
    <div className="max-w-7xl mx-auto px-6 py-12 space-y-12 text-slate-800 dark:text-slate-100 text-left">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {facilities.map((fac, idx) => (
          <div 
            key={idx} 
            className="glassmorphism rounded-2xl p-6 shadow-xl border border-white/40 hover:-translate-y-1.5 transition-all duration-300 flex flex-col justify-between"
          >
            <div>
              ...
              <p className="text-xs text-slate-650 dark:text-slate-400 font-light leading-relaxed mb-4">{fac.desc}</p>
            </div>
