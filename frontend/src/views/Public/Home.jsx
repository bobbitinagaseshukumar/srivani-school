...
export default function Home({ onNavigate }) {
  const { circulars, tickerItems, schoolInfo, testimonials, admissionBanner, homepageStats, homepageInfrastructure } = useContext(AppContext);
  ...
  const iconMap = { Users, GraduationCap, Award, BookOpen };
  const stats = (homepageStats || []).map((stat) => ({
    ...stat,
    icon: iconMap[stat.icon] || Users
  }));

  const facilities = homepageInfrastructure || [];
