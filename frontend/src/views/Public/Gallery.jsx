      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {filteredItems.map((item, idx) => (
          <ScrollReveal key={idx} className="h-full">
            <div 
              className="group bg-white dark:bg-slate-800/40 rounded-2xl overflow-hidden shadow-lg border border-slate-200/50 dark:border-slate-800 relative cursor-pointer h-full"
